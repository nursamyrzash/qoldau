...
const DIAGNOSES = {
kk: ['Аутизм','ДЦП','Синдром Дауна','Есту кемістігі','Сөйлеу кемістігі','Мүгедектік','Басқа'],
ru: ['Аутизм','ДЦП','Синдром Дауна','Нарушение слуха','Нарушение речи','Инвалидность','Другое'],
en: ['Autism','Cerebral Palsy','Down Syndrome','Hearing impairment','Speech disorder','Disability','Other']
};
...
const CITIES = ['Қостанай / Костанай','Астана','Алматы','Шымкент','Қарағанды / Каражанды','Басқа / Другое / Other'];
